  ...
  return (
    <header className="w-full px-4 sm:px-8 md:px-12 py-3 md:py-4 flex items-center justify-between relative z-30 shrink-0 select-none animate-fade-in delay-100">
      ...
      <div className="flex items-center">
        <a href="#" className="flex items-center gap-2 sm:gap-2.5 focus:outline-none focus:ring-2 focus:ring-[#31b1ba] rounded-md transition-transform hover:scale-[1.02]">
          <svg
            viewBox="0 0 100 100"
            fill="currentColor"
            className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-[#31b1ba] shrink-0"
          ...
          <span className="font-serif-display text-2xl md:text-3xl text-[#31b1ba] font-bold tracking-tight leading-none">
            RoyalPet's
          </span>
        </a>
      </div>
      ...
      <div className="flex items-center gap-2.5 sm:gap-3.5">
        ...
        <button
          ...
          aria-label="Search"
          className="flex items-center justify-center w-10 h-10 rounded-full border border-[#31b1ba]/20 text-[#31b1ba] hover:border-[#31b1ba] hover:bg-white/60 transition-all focus:outline-none focus:ring-2 focus:ring-[#31b1ba]"
        >
        ...
        <button
          onClick={onOpenSearch}
          className="bg-[#31b1ba] hover:bg-[#22828a] text-[#FFC72C] font-semibold text-xs sm:text-sm px-5 py-2.5 rounded-full transition-all shadow-sm hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#31b1ba] cursor-pointer"
        >
          Let's Try
        </button>
      </div>
